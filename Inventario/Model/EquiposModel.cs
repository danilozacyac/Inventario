...
namespace Inventario.Model
{
    public class EquiposModel
    {
        ...
        /// <returns></returns>
        public List<Equipos> GetEquiposPorParametro(String parametroBusqueda, String valorParametro)
        {
        ...
        public void BajaEquipo(List<Equipos> equiposEliminar, String observaciones)
        {
            SqlConnection sqlConne = Conexion.GetConexion();
            SqlCommand cmd;
