...
namespace Inventario.Model
{
    public class ServidoresModel
    {
            ...
            try
            {
                ...
                if (dataReader.HasRows)
                {
                    while (dataReader.Read())
                    {
                        ...
                        //servidorP.Equipos = (AccesoUsuarioModel.Grupo == 1 || AccesoUsuarioModel.Grupo == 3) ? new EquiposModel().GetEquiposPorParametro("Expediente", servidorP.Expediente.ToString()) :
        ...
        public void SetNewUser()
        {
            ...
            servidor.Equipos = new List<Equipos>();
